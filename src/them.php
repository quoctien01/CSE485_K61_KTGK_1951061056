...
<body>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input name="ten" type="text" class="form-control" id="exampleInput">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input name="sdt" type="text" class="form-control" id="exampleInput">
        ...
        <button name="btthem" type="submit" class="btn btn-primary">Thêm</button>
    </form>
